...
public class Auction extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            createExceSheet(datas,"./scrape_gibson.xlsx");
        } catch (IOException e) {
            e.printStackTrace();
        }
...
private void createExceSheet(List<AuctionContent> datas,String path) throws IOException {
        ...
        for (AuctionContent data : datas) {
            ...
            row.createCell(8).setCellValue(data.getAuctionDate());
            row.createCell(9).setCellValue(data.getAuctionTime());
            row.createCell(10).setCellValue(data.getDescription());
            row.createCell(11).setCellValue(data.getFeatures());
            row.createCell(12).setCellValue(data.getAccomadation());
            row.createCell(13).setCellValue(data.getDisclaimer());
        }
